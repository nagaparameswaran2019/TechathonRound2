    ...
    public partial class tablecreation : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_LookUpGroups", x => x.LookUpGroupId);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    CoreDocumentStatus = table.Column<string>(type: "nvarchar(20)", maxLength: 20, nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    AdharNo = table.Column<string>(type: "nvarchar(20)", maxLength: 20, nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ChairmanName = table.Column<string>(type: "nvarchar(250)", maxLength: 250, nullable: false),
                    DeanName = table.Column<string>(type: "nvarchar(250)", maxLength: 250, nullable: false),
                    AspNetUsersId = table.Column<string>(type: "nvarchar(900)", maxLength: 900, nullable: false),
                    AddressId = table.Column<int>(type: "int", nullable: false)
                },
                constraints: table =>
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    DocumentStatus = table.Column<string>(type: "nvarchar(250)", maxLength: 250, nullable: false),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_CertificationVerification", x => x.Id);
                    table.ForeignKey(
                        name: "FK_CertificationVerification_Document_DocumentId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_LookUp_LookUpGroups_LookUpGroupId",
                        column: x => x.LookUpGroupId,
                        principalTable: "LookUpGroups",
                        principalColumn: "LookUpGroupId",
                        onDelete: ReferentialAction.Cascade);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ModifiedOn = table.Column<DateTime>(type: "datetime2", nullable: false),
                    ModifiedBy = table.Column<int>(type: "int", nullable: false),
                    PaymentTransactionNo = table.Column<string>(type: "nvarchar(250)", maxLength: 250, nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateIndex(
                name: "IX_CertificationVerification_DocumentId",
                table: "CertificationVerification",
                column: "DocumentId");
